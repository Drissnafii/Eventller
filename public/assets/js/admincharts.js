    ...
    data.map((item) => {
        ...
        <div class="bg-gray-800/30 backdrop-blur-sm rounded-lg p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                ...
                ${item.title == 'Active Users'  && `<div class="bg-pink-600/20 p-2 rounded-lg">
                ...
                ${item.title == 'Total Revenue'  && `<div class="bg-green-600/20 p-2 rounded-lg">
                  ...
                  ${item.title == 'Total Events'  && `<div class="bg-blue-600/20 p-2 rounded-lg">

    ...
    data.map((item) => {
        ...
        <div class="bg-gray-800/30 backdrop-blur-sm rounded-lg p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                <h3 class="text-gray-400 text-sm font-medium">{{card.title }}</h3>
                ${item.title == 'Total Events'  && ` <div class="bg-purple-600/20 p-2 rounded-lg">
                ...
                {% elseif  card.title == 'Active Users' %}
                ...
                {% elseif  card.title == 'Total Revenue' %}
                ...
                {% elseif  card.title == 'Total Events' %}
